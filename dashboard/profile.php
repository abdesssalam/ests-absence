...
<div class="w-full ">
    ...
    <h1 class="text-center text-2xl font-semibold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl mt-3 mb-8"> <span id="title-profile-page"></span> </h1>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
            <div class="w-1/2 mx-auto flex md:flex-row flex-col justify-between items-center mb-2">
                <div class="w-full md:w-1/2 mr-1">
                    <label for="nom" class="block mb-2 text-sm font-medium text-gray-900 "><span id="label-lastName"></span></label>
                ...
                <div class="w-full md:w-1/2">
                    <label for="prenom" class="block mb-2 text-sm font-medium text-gray-900 "> <span id="label-firstName"></span> </label>
            ...
            <div class="w-1/2 mx-auto mb-2">
                <label for="email" class="block mb-2 text-sm font-medium text-gray-900 "><span id="label-email"></span></label>
            ...
            <div class="w-1/2 mx-auto mb-2">
                <label for="pass_old" class="block  mb-2 text-sm font-medium text-gray-900 "><span id="label-currentPass"></span></label>
            ...
            <div class="w-1/2 mx-auto mb-2">
                <label for="pass_nv" class="block mb-2 text-sm font-medium text-gray-900 "><span id="label-newPass"></span></label>
            ...
            <div class="w-1/2 mx-auto mb-2">
                <label for="pass_nv_conf" class="block mb-2 text-sm font-medium text-gray-900 "><span id="label-confNewPass"></span></label>
