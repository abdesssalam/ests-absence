...
<div id="alertS" class="hidden p-4 mb-4 text-center w-1/2 mx-auto text-sm text-green-700 bg-green-100 rounded-lg dark:bg-green-200 dark:text-green-800" role="alert">
    ...
    <div class="my-2 flex content-around focus:outline-none">
        ...
        <input class="p-1  rounded-sm w-2/3" type="text" id="NomMatier">
    </div>

    <div class="my-2 flex content-around focus:outline-none">
            <label class="font-medium text-lg capitalize  w-1/3" for="">Module :</label>
             <select id="module"  class="w-2/3 bg-white border border-white text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  p-2.5 ">
               
            </select>
    </div>
    
        <input id="btn_add_matier" class="block text-white w-1/4 mx-auto bg-green-500 py-2 px-3 font-semibold my-2 cursor-pointer rounded-md uppercase hover:text-gray-600" type="submit" value="ajouter">
